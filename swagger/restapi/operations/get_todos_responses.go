...
type GetTodosOK struct {
	...
	/*
	  In: Body
	*/
	Payload *GetTodosOKBody `json:"body,omitempty"`
}
...
func (o *GetTodosOK) WithPayload(payload *GetTodosOKBody) *GetTodosOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get todos o k response
func (o *GetTodosOK) SetPayload(payload *GetTodosOKBody) {
	o.Payload = payload
}
