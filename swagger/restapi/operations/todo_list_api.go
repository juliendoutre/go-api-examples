...
func NewTodoListAPI(spec *loads.Document) *TodoListAPI {
	return &TodoListAPI{
		...
		GetTodoByNameHandler: GetTodoByNameHandlerFunc(func(params GetTodoByNameParams) middleware.Responder {
			return middleware.NotImplemented("operation GetTodoByName has not yet been implemented")
		}),
...
/*TodoListAPI A todo list manager */
type TodoListAPI struct {
	...
	// GetTodoByNameHandler sets the operation handler for the get todo by name operation
	GetTodoByNameHandler GetTodoByNameHandler
...
func (o *TodoListAPI) Validate() error {
	...
	if o.GetTodoByNameHandler == nil {
		unregistered = append(unregistered, "GetTodoByNameHandler")
	}
...
func (o *TodoListAPI) initHandlerCache() {
	...
	o.handlers["POST"]["/todos"] = NewAddTodo(o.context, o.AddTodoHandler)

	if o.handlers["GET"] == nil {
		o.handlers["GET"] = make(map[string]http.Handler)
	}
	o.handlers["GET"]["/todos/{name}"] = NewGetTodoByName(o.context, o.GetTodoByNameHandler)

	if o.handlers["GET"] == nil {
		o.handlers["GET"] = make(map[string]http.Handler)
	}
	o.handlers["GET"]["/todos"] = NewGetTodos(o.context, o.GetTodosHandler)
